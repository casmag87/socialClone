...
public class LoginEndpoint {
    ...
    public Response login(String jsonString) throws AuthenticationFailedException, API_Exception {
        String username;
        String password;
        try {
        ...
        } catch (JOSEException | AuthenticationFailedException ex) {
